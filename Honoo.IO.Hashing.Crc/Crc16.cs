namespace Honoo.IO.Hashing
{
    ...
    public sealed class Crc16 : Crc
    {
        ...
        /// </summary>
        public Crc16(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <returns></returns>
        public static Crc16 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16(withTable);
        }
        ...
        private static CrcEngine GetEngine(CrcTableInfo withTable)
        {
            ...
            switch (withTable)
            {
                case CrcTableInfo.Standard: return new CrcEngine16Standard(WIDTH, POLY, INIT, XOROUT, REFIN, REFOUT, CrcEngine16Standard.GenerateTable(WIDTH, POLY, REFIN));
                case CrcTableInfo.M16x: return new CrcEngine16M16x(WIDTH, POLY, INIT, XOROUT, REFIN, REFOUT, CrcEngine16M16x.GenerateTable(WIDTH, POLY, REFIN));
    ...
    public sealed class Crc16Ccitt : Crc
    {
        ...
        /// </summary>
        public Crc16Ccitt(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Ccitt Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Ccitt(withTable);
        }
    ...
    public sealed class Crc16CcittFalse : Crc
    {
        ...
        /// </summary>
        public Crc16CcittFalse(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16CcittFalse Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16CcittFalse(withTable);
        }
    ...
    public sealed class Crc16Cdma2000 : Crc
    {
        ...
        /// </summary>
        public Crc16Cdma2000(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Cdma2000 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Cdma2000(withTable);
        }
    ...
    public sealed class Crc16Cms : Crc
    {
        ...
        /// </summary>
        public Crc16Cms(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Cms Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Cms(withTable);
        }
    ...
    public sealed class Crc16Dds110 : Crc
    {
        ...
        /// </summary>
        public Crc16Dds110(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Dds110 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Dds110(withTable);
        }
    ...
    public sealed class Crc16DectR : Crc
    {
        ...
        /// </summary>
        public Crc16DectR(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16DectR Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16DectR(withTable);
        }
    ...
    public sealed class Crc16DectX : Crc
    {
        ...
        /// </summary>
        public Crc16DectX(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16DectX Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16DectX(withTable);
        }
    ...
    public sealed class Crc16Dnp : Crc
    {
        ...
        /// </summary>
        public Crc16Dnp(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Dnp Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Dnp(withTable);
        }
    ...
    public sealed class Crc16En13757 : Crc
    {
        ...
        /// </summary>
        public Crc16En13757(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16En13757 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16En13757(withTable);
        }
    ...
    public sealed class Crc16Genibus : Crc
    {
        ...
        /// </summary>
        public Crc16Genibus(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Genibus Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Genibus(withTable);
        }
    ...
    public sealed class Crc16Gsm : Crc
    {
        ...
        /// </summary>
        public Crc16Gsm(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Gsm Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Gsm(withTable);
        }
    ...
    public sealed class Crc16Lj1200 : Crc
    {
        ...
        /// </summary>
        public Crc16Lj1200(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Lj1200 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Lj1200(withTable);
        }
    ...
    public sealed class Crc16M17 : Crc
    {
        ...
        /// </summary>
        public Crc16M17(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16M17 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16M17(withTable);
        }
    ...
    public sealed class Crc16Maxim : Crc
    {
        ...
        /// </summary>
        public Crc16Maxim(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Maxim Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Maxim(withTable);
        }
    ...
    public sealed class Crc16Mcrf4XX : Crc
    {
        ...
        /// </summary>
        public Crc16Mcrf4XX(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Mcrf4XX Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Mcrf4XX(withTable);
        }
    ...
    public sealed class Crc16Modbus : Crc
    {
        ...
        /// </summary>
        public Crc16Modbus(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Modbus Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Modbus(withTable);
        }
    ...
    public sealed class Crc16Nrsc5 : Crc
    {
        ...
        /// </summary>
        public Crc16Nrsc5(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Nrsc5 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Nrsc5(withTable);
        }
    ...
    public sealed class Crc16OpensafetyA : Crc
    {
        ...
        /// </summary>
        public Crc16OpensafetyA(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16OpensafetyA Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16OpensafetyA(withTable);
        }
    ...
    public sealed class Crc16OpensafetyB : Crc
    {
        ...
        /// </summary>
        public Crc16OpensafetyB(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16OpensafetyB Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16OpensafetyB(withTable);
        }
    ...
    public sealed class Crc16Profibus : Crc
    {
        ...
        /// </summary>
        public Crc16Profibus(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Profibus Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Profibus(withTable);
        }
    ...
    public sealed class Crc16Riello : Crc
    {
        ...
        /// </summary>
        public Crc16Riello(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Riello Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Riello(withTable);
        }
    ...
    public sealed class Crc16SpiFujitsu : Crc
    {
        ...
        /// </summary>
        public Crc16SpiFujitsu(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16SpiFujitsu Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16SpiFujitsu(withTable);
        }
    ...
    public sealed class Crc16T10Dif : Crc
    {
        ...
        /// </summary>
        public Crc16T10Dif(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16T10Dif Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16T10Dif(withTable);
        }
    ...
    public sealed class Crc16Teledisk : Crc
    {
        ...
        /// </summary>
        public Crc16Teledisk(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Teledisk Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Teledisk(withTable);
        }
    ...
    public sealed class Crc16Tms37157 : Crc
    {
        ...
        /// </summary>
        public Crc16Tms37157(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Tms37157 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Tms37157(withTable);
        }
    ...
    public sealed class Crc16Umts : Crc
    {
        ...
        /// </summary>
        public Crc16Umts(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Umts Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Umts(withTable);
        }
    ...
    public sealed class Crc16Usb : Crc
    {
        ...
        /// </summary>
        public Crc16Usb(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Usb Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Usb(withTable);
        }
    ...
    public sealed class Crc16X25 : Crc
    {
        ...
        /// </summary>
        public Crc16X25(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16X25 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16X25(withTable);
        }
    ...
    public sealed class Crc16Xmodem : Crc
    {
        ...
        /// </summary>
        public Crc16Xmodem(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Xmodem Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Xmodem(withTable);
        }
    ...
    public sealed class Crc16Xmodem2 : Crc
    {
        ...
        /// </summary>
        public Crc16Xmodem2(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static Crc16Xmodem2 Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new Crc16Xmodem2(withTable);
        }
    ...
    public sealed class CrcA : Crc
    {
        ...
        /// </summary>
        public CrcA(CrcTableInfo withTable = CrcTableInfo.Standard) : base(DEFAULT_NAME, GetEngine(withTable))
        {
        }
        ...
        /// <param name="withTable">Calculate with table.</param>
        /// <returns></returns>
        public static CrcA Create(CrcTableInfo withTable = CrcTableInfo.Standard)
        {
            return new CrcA(withTable);
        }
