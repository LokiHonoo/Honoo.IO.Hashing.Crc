namespace Honoo.IO.Hashing
{
    ...
    public sealed class Crc17CanFd : Crc
    {
        ...
        {
            return new CrcName(DEFAULT_NAME, WIDTH, new CrcParameter(POLY, WIDTH), new CrcParameter(INIT, WIDTH), new CrcParameter(XOROUT, WIDTH), REFIN, REFOUT, (t) => { return new Crc17CanFd(t); });
        }
