...
namespace Honoo.IO.Hashing
{
    internal sealed class CrcEngine64 : CrcEngine
    {
        ...
        internal override CrcCore Core => CrcCore.UInt64;
        ...
        internal CrcEngine64(int width, bool refin, bool refout, ulong poly, ulong init, ulong xorout, CrcTable withTable)
        {
            if (width <= 0 || width > 64)
            {
