...
namespace Honoo.IO.Hashing
{
    internal sealed class CrcEngine64 : CrcEngine
    {
        ...
        private static string GetBinaryString(ulong input, bool withPrefix, int width)
        {
        ...
        private static string GetHexString(ulong input, bool withPrefix, int hexLength)
        {
